    ...
    <div className="bg-gray-100 font-family-karla flex">
      ...
      <aside className="relative bg-sidebar bg-blue-500 h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav className="text-white text-base font-semibold pt-3">
          <a href="/dashboard" className="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
            <i className="fas fa-tachometer-alt mr-3"></i>
            Dashboard
          </a>
          <a href="/dashboard/my-product" className="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
            <i className="fas fa-sticky-note mr-3"></i>
            My Product
          </a>
          <a href="/dashboard/transaction" className="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
            <i className="fas fa-table mr-3"></i>
            Transactions
          </a>
          <a href="/dashboard/store-setting" className="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
            <i className="fas fa-align-left mr-3"></i>
            Store Settings
          </a>
          <a href="/dashboard/my-account" className="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
